...
const PageLoader = () => (
  <div className="min-h-screen flex items-center justify-center">
    <div
      className="animate-spin rounded-full h-12 w-12 border-2 border-purple-500/30 border-t-purple-500"
      aria-hidden="true"
    ></div>
    ...
    <Router {...routerOptions}>
      <AuthProvider>
        <ThemeProvider>
          ...
          <div
            className="fixed inset-0 bg-gradient-to-br from-gray-900 to-purple-900"
            aria-hidden="true"
          />
          <div
            className="fixed inset-0 bg-grid-pattern opacity-5"
            aria-hidden="true"
          />
