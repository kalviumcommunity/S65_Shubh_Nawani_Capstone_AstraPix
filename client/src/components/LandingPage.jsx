                    ...
                    <>
                        ...
                        <video
                            ...
                            style={{
                                ...
                                width: "100vw",
                                objectPosition:
                                    window.innerWidth < 640 ? "70%" : "center",
                ...
                <div className="pt-16 sm:pt-20 space-y-16 sm:space-y-24 md:space-y-32 pb-16">
                            ...
                            <div className="text-center">
                                ...
                                >
                                    ...
                                    <span className="block">
                                        Create unique, professional-grade
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-8 sm:mb-16">
                            ...
                            <p className="text-base sm:text-lg text-gray-300 max-w-3xl mx-auto">
                                Create stunning visuals in just a few simple
                                steps
                            </p>
                        </div>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-8 sm:mb-16">
                            ...
                            <p className="text-base sm:text-xl text-gray-300 max-w-3xl mx-auto">
                                Experience the future of AI-powered image
                                generation
                            </p>
                        </div>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center relative">
                            ...
                            <p className="text-sm sm:text-base text-gray-400 mb-6 sm:mb-8 max-w-2xl mx-auto">
                                ...
                                AstraPix to bring their ideas to life.
                            </p>
                            <button
                                onClick={() => navigate("/auth")}
