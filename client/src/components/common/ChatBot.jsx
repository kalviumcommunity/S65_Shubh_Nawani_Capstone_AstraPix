...
const initialMessages = [
    ...
    },
    {
        type: "bot",
        content:
            "I can help you with image generation, pricing plans, and technical features. Feel free to ask anything!",
        timestamp: new Date(),
    },
];
...
const ChatBot = () => {
    ...
    useEffect(() => {
        if (!document.getElementById("markdown-styles")) {
            ...
            return () => {
                const existingStyle =
                    document.getElementById("markdown-styles");
                if (existingStyle) {
    ...
    const handleSend = useCallback(
        async (messageContent = inputMessage.trim()) => {
