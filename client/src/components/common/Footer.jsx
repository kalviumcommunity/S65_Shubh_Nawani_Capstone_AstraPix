          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-8">
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <p className="text-xs sm:text-sm text-white/70 max-w-[200px] sm:max-w-none">
                Transforming imagination into reality through AI-powered image
                generation.
              </p>
            </div>
              ...
              <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm">
                <li>
                  <Link
                    to="/"
                    onClick={scrollToTop}
                    className="text-white/70 hover:text-white transition-colors cursor-pointer block"
                  >
                    Home
                  </Link>
                </li>
          ...
          <div className="mt-5 sm:mt-8 pt-4 border-t border-white/10">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-3">
              <div className="text-xs sm:text-sm text-white/70 order-2 sm:order-1 sm:w-1/3">
                <p>
                  © {new Date().getFullYear()} AstraPix Inc. All rights
                  reserved.
                </p>
              </div>
